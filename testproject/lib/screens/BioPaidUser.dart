  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        SafeArea(child: Obx(() {
          return controller.profile.value.name == null ? Container() : SingleChildScrollView(
            child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Image.asset("lib/assets/images/heart.png"),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  shape: BoxShape.circle),
                              child:
                                  Image.asset("lib/assets/images/dislike.png"),
                            ),
                          ),
                        ],
                      ),
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children:
                              controller.mediaList.asMap().entries.map((entry) {
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                children: [
                                  Padding(
                                    padding: EdgeInsets.only(
                                        left: 20, bottom: 15.0, top: 15, right: 20.0),
                                    child: Text(
                                      "Name",
                                      style: TextStyle(
                                        fontFamily: 'Helvetica Neue',
                      ...
                      Padding(
                        ...
                        child: Container(
                          height: controller.profile.value.instagram!.length > 0
                              ? 250
                              : 0,
                          child: GridView.count(
                              ...
                              children: List.generate(
                                ...
                                var imageName = controller
                                    .profile.value.instagram![index].mediaUrl!;
                                return Padding(
                          ...
                          child: FittedBox(
                            child: Scatter(
                              ...
                              delegate: EllipseScatterDelegate(
                                ...
                                b: 185.0,
                                step: 1.0 /
                                    controller.profile.value.interests!.length,
                              ),
                              children:
                                  controller.profile.value.interests!.map((e) {
                                return Container(
                                    width: 175,
                                    height: 175,
                                    decoration: BoxDecoration(
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: new BoxDecoration(
                                borderRadius: BorderRadius.circular(10.0),
                              color: Color.fromRGBO(38, 153, 251, 0.35)
                                ),
                            padding: const EdgeInsets.all(5.0),
                            child: Center(
                              child: Text(
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: new BoxDecoration(
                              borderRadius: BorderRadius.circular(10.0),
                                color: Color.fromRGBO(222, 222, 222, 0.35)
                            ),
                            padding: const EdgeInsets.all(5.0),
                            child: Center(
                              child: Text(
